...
export function PreliminaryChecklistInfo({
  ...
  return (
    <div className="group relative inline-flex">
      ...
      <div className="pointer-events-none absolute right-0 top-full z-50 mt-3 hidden w-[420px] rounded-md border border-slate-200 bg-white p-5 text-left shadow-xl group-hover:block group-focus-within:block">
